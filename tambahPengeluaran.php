...
<head>
    ...
    <title>Sistem Pencatatan Pengeluaran - Tambah Data</title>
...
<body>
    <div class="header">
        ...
        <h3 class="text-secondary font-weight-bold float-left logo">Sistem Pencatatan</h3>
        <h3 class="text-secondary float-left logo2">Pengeluaran</h3>
        <a href="logout">
            <div class="logout">
