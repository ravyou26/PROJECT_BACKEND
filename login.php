...
<head>
  ...
  <title>Login | Sistem Pencatatan Pengeluaran</title>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan Sistem Pencatatan Pengeluaran</div>
              </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Login untuk gunakan Sistem Pencatatan Pengeluaran</div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
